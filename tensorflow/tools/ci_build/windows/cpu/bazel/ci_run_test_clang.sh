...
export PATH=/c/ProgramData/chocolatey/bin:/c/Tools/bazel:/c/Program\ Files/Git:/c/Program\ Files/Git/cmd:/c/msys64:/c/msys64/usr/bin:/c/Windows/system32:/c/Windows:/c/Windows/System32/Wbem:/c/Program\ Files/LLVM/bin:/c/Windows/System32/OpenSSH
...
bazel --windows_enable_symlinks test \
  ...
  --config=opt --copt=/std:c++latest --copt=/clang:-Weverything --linkopt=/FORCE:MULTIPLE --host_linkopt=/FORCE:MULTIPLE \
